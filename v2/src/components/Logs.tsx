...
const DemoCard: React.FC<{ title: string; tags: string[]; desc: string; featured?: boolean }> = ({ title, tags, desc, featured }) => (
    <div className={`glass-card p-6 flex flex-col group relative overflow-hidden transition-all duration-300 hover:border-purple-glow ${featured ? 'md:col-span-2 bg-purple-accent/5' : ''}`}>
...
export const Logs: React.FC = () => {
    ...
    return (
        <div ref={containerRef} className="relative min-h-screen w-full bg-cyber-black pt-24 pb-8 px-4 md:px-8 flex flex-col items-center">
